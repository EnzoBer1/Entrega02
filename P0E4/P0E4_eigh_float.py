...
txt0 = open("timing_eigh_caso_1_float.txt","w")
txt1 = open("timing_eigh_caso_2_float.txt","w")
txt2 = open("timing_eigh_caso_3_float.txt","w")
txt3 = open("timing_eigh_caso_4_float.txt","w")
txt4 = open("timing_eigh_caso_5_float.txt","w")
txt5 = open("timing_eigh_caso_6_float.txt","w")
txt6 = open("timing_eigh_caso_7_float.txt","w")
txt7 = open("timing_eigh_caso_8_float.txt","w")
txt8 = open("timing_eigh_caso_9_float.txt","w")
...
plt.title("Rendimiento de Scipy.linalg.eigh() para float")
plt.grid()
plt.show()
