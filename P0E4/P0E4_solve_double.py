...
txt0 = open("timing_solve_caso_1_double.txt","w")
...
txt1 = open("timing_solve_caso_2_double.txt","w")
...
txt2 = open("timing_solve_caso_3_double.txt","w")
...
txt3 = open("timing_solve_caso_4_double.txt","w")
...
txt4 = open("timing_solve_caso_5_double.txt","w")
...
txt5 = open("timing_solve_caso_6_double.txt","w")
...
txt6 = open("timing_solve_caso_7_double.txt","w")
...
plt.title("Rendimieto de Scipy.linalg.solve() para double")
plt.grid()
