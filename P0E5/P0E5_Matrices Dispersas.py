...
txt = open("timing_MATMUL_Matriz_Dispersa_double.txt","w")
...
for corrida in corridas:
    for N in Ns:
        ...
        A = sparse.csr_matrix(laplaciana(N))
        B = sparse.csr_matrix(laplaciana(N))
...
for i in range(len(corridas)):
    ...
    plt.title("Desempeño A@B para Matrices Dispersas")
