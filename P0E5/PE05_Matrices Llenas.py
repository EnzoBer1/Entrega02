...
Ns = [2,10,20,50,100,200,500,1000,1500,2000]
...
dts_solucion = [] #guardo los tiempos en que se soluciona A*B por corrida
dts_ensamblaje = [] #guardo los tiempos en que se ensambla el sistema por corrida

txt = open("timing_MATMUL_Matriz_Llena_double.txt","w")
...
y1 = ["0.01 ms","1 ms","10 ms","0.1 s","1 s","10 s","1 min","10 min"]
y2 = ["1 KB","10 KB","100 KB","1 MB","10 MB","100 MB","1 GB","10 GB"]
sin = ["","","","","","","","","","",""]

tiempo1 = [0.00001,1/1000,10/1000,0.1,1,10,60,60*10]
...
for i in range(len(corridas)):
    ...
    plt.title("Desempeño A@B para Matrices Llenas")
